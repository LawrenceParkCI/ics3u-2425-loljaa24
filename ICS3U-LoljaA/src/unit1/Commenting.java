...
/**
* Description: This program teaches the programmer about comments
* Date: Oct 15, 2024
* @author Arti Lolja
*/
public class Commenting {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    int num1 = 20; // num1 = 20
    double num2 = 36.2; // num2 = 36.2
    String stringNum = ""; // stringNum = ""
    ...
    */
    ...
    System.out.print(stringNum); // 52 -16.0; 26 - 6.4
